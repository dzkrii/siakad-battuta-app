        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <div class="d-sm-none d-lg-inline-block">
                    ...
                    @if (Auth::guard('admin')->check())
                        {{ Auth::guard('admin')->user()->name }} <!-- Menampilkan nama Admin -->
                    @elseif (Auth::guard('student')->check())
                        {{ Auth::guard('student')->user()->name }} <!-- Menampilkan nama Mahasiswa -->
                    @elseif (Auth::guard('lecturer')->check())
                        {{ Auth::guard('lecturer')->user()->name }} <!-- Menampilkan nama Dosen -->
                    @else
                        Guest
                    @endif
                </div>
